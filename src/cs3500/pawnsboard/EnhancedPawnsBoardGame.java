...
import cs3500.pawnsboard.model.EnhancedPawnsBoardBuilder;
...
/**
 * Represents an EnhancedPawnsBoard game played with game cards with upgrade and devalue influence
 * grid cells.
 */
public final class EnhancedPawnsBoardGame {
  ...
  public static void main(String[] args) throws IOException {
    PawnsBoardBuilder builder = new EnhancedPawnsBoardBuilder();
    String p1DeckPath = "";
    String p2DeckPath = "";
    String player1Type = "";
    String player2Type = "";
