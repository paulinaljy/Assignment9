 ...
 */
public class PawnsBoardModelTextual implements QueensBlood {
   ...
   */
  public PawnsBoardModelTextual(int width, int height, Random rand, DeckConfiguration deckConfig) {
    if (height < 0) {
   ...
   */
  protected void applyInfluenceGrid(GameCard card, int row, int col, Player currentPlayer) {
